...
document.getElementById('signupForm').addEventListener('submit', async function (e) {
    ...
    try {
        ...
        const originalText = 'Create Account'; // Assuming this is the original text
...
document.addEventListener('DOMContentLoaded', function () {
    // Show loading overlay for initial checks
    showLoadingOverlay();
    ...
    async function checkBackendHealth() {
        try {
            ...
            // Hide loading overlay once check is complete
            hideLoadingOverlay();
        }
    }
